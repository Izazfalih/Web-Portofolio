...
const FuzzyText = ({
  ...
  useEffect(() => {
    ...
    // Menghitung ukuran font langsung dari nilai string (contoh: "90px" -> 90)
    const numericFontSize = parseFloat(fontSize) || 40;
  ...
  // Menggunakan touchAction 'auto' agar tidak menginterupsi gesture scroll bawaan browser
  return <canvas ref={canvasRef} className={className} style={{ touchAction: 'auto' }} />;
};
